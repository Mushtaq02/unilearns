...
<head>
    <meta charset="UTF-8">
    <title><?php echo SITE_NAME; ?> - الرسائل</title>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="student_messages.php"><i class="fas fa-envelope me-2"></i>الرسائل</a>
            ...
            <div class="col-md-9 col-lg-10 p-4">
                <h1 class="h3 mb-4"><i class="fas fa-envelope me-2"></i>الرسائل</h1>
                <div class="card">
                    <div class="card-body text-center py-5">
                        <i class="fas fa-envelope fa-3x text-muted mb-3"></i>
                        <h4 class="text-muted">لا توجد رسائل</h4>
                        <p class="text-muted">لا توجد رسائل في صندوق الوارد. ستظهر الرسائل هنا عند وصولها.</p>
                    </div>
                </div>
            </div>
        </div>
