        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="teacher_assignments.php"><i class="fas fa-tasks me-2"></i>الواجبات</a>
            ...
            <div class="col-md-9 col-lg-10 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3">الواجبات</h1>
                    <span class="badge bg-warning fs-6">0 واجب</span>
                </div>
                <div class="card">
                    <div class="card-body text-center py-5">
                        <i class="fas fa-tasks fa-4x text-muted mb-3"></i>
                        <h4 class="text-muted">لا توجد واجبات</h4>
                        <p class="text-muted">لا توجد واجبات في مقرراتك حالياً.</p>
                    </div>
                </div>
            </div>
        </div>
